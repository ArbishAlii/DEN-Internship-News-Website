...
// The API key is no longer needed here because the call is handled by the serverless function.
const fetchData = async (category, pageSize) => {
  const url = `/api/headlines?category=${category}&pageSize=${pageSize}`;
